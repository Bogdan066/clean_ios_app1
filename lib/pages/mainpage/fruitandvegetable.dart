...
class _VegetablesPageState extends State<VegetablesPage> {
  ...
  final List<Map<String, dynamic>> _allProducts = [
    {'name': 'Помидоры', 'isAdded': false},
    {'name': 'Огурцы', 'isAdded': false},
    {'name': 'Картофель', 'isAdded': false},
    {'name': 'Лук репчатый', 'isAdded': false},
    {'name': 'Морковь', 'isAdded': false},
    {'name': 'Яблоки', 'isAdded': false},
    {'name': 'Бананы', 'isAdded': false},
    {'name': 'Апельсины', 'isAdded': false},
    {'name': 'Перец болгарский', 'isAdded': false},
    {'name': 'Чеснок', 'isAdded': false},
  ];
