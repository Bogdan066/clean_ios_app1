...
class _DrinksPageState extends State<DrinksPage> {
  ...
  final List<Map<String, dynamic>> _allProducts = [
    {'name': 'Вода газированная', 'isAdded': false},
    {'name': 'Вода без газа', 'isAdded': false},
    {'name': 'Сок яблочный', 'isAdded': false},
    {'name': 'Сок апельсиновый', 'isAdded': false},
    {'name': 'Кофе (молотый)', 'isAdded': false},
    {'name': 'Кофе в зернах', 'isAdded': false},
    {'name': 'Чай черный', 'isAdded': false},
    {'name': 'Чай зеленый', 'isAdded': false},
    {'name': 'Лимонад', 'isAdded': false},
    {'name': 'Морс ягодный', 'isAdded': false},
    {'name': 'Квас', 'isAdded': false},
    {'name': 'Энергетический напиток', 'isAdded': false},
  ];
