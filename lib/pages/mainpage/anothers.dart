...
class _OtherPageState extends State<OtherPage> {
  ...
  final List<Map<String, dynamic>> _allProducts = [
    {'name': 'Фольга алюминиевая', 'isAdded': false},
    {'name': 'Пергаментная бумага', 'isAdded': false},
    {'name': 'Пищевая пленка', 'isAdded': false},
    {'name': 'Пакеты для запекания', 'isAdded': false},
    {'name': 'Салфетки бумажные', 'isAdded': false},
    {'name': 'Зубочистки', 'isAdded': false},
    {'name': 'Трубочки для напитков', 'isAdded': false},
    {'name': 'Спички / Зажигалка', 'isAdded': false},
    {'name': 'Контейнеры пищевые', 'isAdded': false},
    {'name': 'Бумажные полотенца', 'isAdded': false},
  ];
