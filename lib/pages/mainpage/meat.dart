...
class _MeatPageState extends State<MeatPage> {
  ...
  final List<Map<String, dynamic>> _allProducts = [
    {'name': 'Куриное филе', 'isAdded': false},
    {'name': 'Говядина', 'isAdded': false},
    {'name': 'Свинина', 'isAdded': false},
    {'name': 'Фарш домашний', 'isAdded': false},
    {'name': 'Лосось', 'isAdded': false},
    {'name': 'Креветки', 'isAdded': false},
    {'name': 'Индейка', 'isAdded': false},
    {'name': 'Баранина', 'isAdded': false},
  ];
