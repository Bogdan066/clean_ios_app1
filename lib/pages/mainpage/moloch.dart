...
class _DairyPageState extends State<DairyPage> {
  ...
  final List<Map<String, dynamic>> _allProducts = [
    {'name': 'Молоко (10%)', 'isAdded': false},
    {'name': 'Молоко (20%)', 'isAdded': false},
    {'name': 'Творог', 'isAdded': false},
    {'name': 'Йогурт', 'isAdded': false},
    {'name': 'Сметана (10%)', 'isAdded': false},
    {'name': 'Сметана (15%)', 'isAdded': false},
    {'name': 'Кефир', 'isAdded': false},
  ];
