...
class _SweetsPageState extends State<SweetsPage> {
  ...
  final List<Map<String, dynamic>> _allProducts = [
    {'name': 'Шоколад молочный', 'isAdded': false},
    {'name': 'Шоколад горький', 'isAdded': false},
    {'name': 'Печенье овсяное', 'isAdded': false},
    {'name': 'Вафли', 'isAdded': false},
    {'name': 'Зефир', 'isAdded': false},
    {'name': 'Мармелад', 'isAdded': false},
    {'name': 'Конфеты шоколадные', 'isAdded': false},
    {'name': 'Пирожное эклер', 'isAdded': false},
    {'name': 'Мед натуральный', 'isAdded': false},
    {'name': 'Варенье малиновое', 'isAdded': false},
    {'name': 'Мороженое пломбир', 'isAdded': false},
  ];
