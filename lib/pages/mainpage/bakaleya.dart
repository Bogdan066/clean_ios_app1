...
class _GroceryPageState extends State<GroceryPage> {
  ...
  final List<Map<String, dynamic>> _allProducts = [
    {'name': 'Рис', 'isAdded': false},
    {'name': 'Гречка', 'isAdded': false},
    {'name': 'Макароны', 'isAdded': false},
    {'name': 'Овсянка', 'isAdded': false},
    {'name': 'Мука', 'isAdded': false},
    {'name': 'Сахар', 'isAdded': false},
    {'name': 'Соль', 'isAdded': false},
    {'name': 'Подсолнечное масло', 'isAdded': false},
    {'name': 'Оливковое масло', 'isAdded': false},
    {'name': 'Чечевица', 'isAdded': false},
  ];
